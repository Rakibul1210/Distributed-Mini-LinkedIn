...
const NotificationPost = () => {
    ...
    useEffect(() => {
     ...
     notificationAPI.get('/getNotifiedPost',{
            ...
            <div>
                <Container className="align-items-center"
                    ...
                    <Row>
                        ...
                        <Col style={{marginTop:'80px', marginLeft: "10px", marginRight: "10px", height: '100%' }} md={6}>
                            ...
                            <div style={{ marginTop: '20px' }}>
                                <div>
                                    <div className='border rounded bg-light'
                                        style={{
                                            marginBottom: '20px',
                                            borderColor: "gray", borderRadius: '10px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'
                                        }}>
